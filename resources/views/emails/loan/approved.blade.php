...
<head>
    ...
    <title>{{ $appName }} — Loan Approved</title>
    <style>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" width="600" class="container" style="width:600px; max-width:600px; background:#ffffff; border:1px solid #e6e9f2; border-radius:12px; overflow:hidden;">
                ...
                <tr>
                    <td class="px" style="padding:24px;">
                        <div style="font-size:18px; font-weight:700; color:#0f172a;">Loan approved</div>
                        ...
                        <div style="margin-top:16px;">
                            <span style="display:inline-block; padding:6px 10px; font-size:12px; font-weight:700; border-radius:999px; background:#dcfce7; color:#166534;">
                                APPROVED
                            </span>
                        </div>

                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top:18px; border:1px solid #e7f6ec; border-radius:10px;">
                            <tr>
                                <td class="px" style="padding:14px 16px; background:#f8fafc; border-bottom:1px solid #e7f6ec;">
                                ...
                                <td class="px" style="padding:14px 16px;">
                                    <table role="presentation" cellpadding="0" cellspacing="0" width="100%">
                                        <tr>
                                            ...
                                            <td class="stack" style="width:33.33%; padding:6px 0;">
                                                <div style="font-size:12px; color:#64748b;">Approved Amount</div>
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top:20px;">
                            <tr>
                                <td align="left">
                                    <a href="{{ $loanShowUrl }}" class="cta" style="display:inline-block; background:#16a34a; color:#ffffff; text-decoration:none; font-weight:700; font-size:14px; padding:12px 16px; border-radius:10px;">
                                        View Application
                                    </a>
                                </td>
                            </tr>
