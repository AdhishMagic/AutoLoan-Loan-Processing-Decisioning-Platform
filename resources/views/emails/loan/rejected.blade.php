...
<head>
    ...
    <title>{{ $appName }} — Application Update</title>
    <style>
            ...
            <table role="presentation" cellpadding="0" cellspacing="0" width="600" class="container" style="width:600px; max-width:600px; background:#ffffff; border:1px solid #e6e9f2; border-radius:12px; overflow:hidden;">
                ...
                <tr>
                    <td class="px" style="padding:24px;">
                        <div style="font-size:18px; font-weight:700; color:#0f172a;">Application update</div>
                        <div style="margin-top:8px; font-size:14px; color:#334155; line-height:1.6;">
                            Thank you for applying. At this time, we’re unable to approve this application.
                        </div>

                        <div style="margin-top:16px;">
                            <span style="display:inline-block; padding:6px 10px; font-size:12px; font-weight:700; border-radius:999px; background:#fee2e2; color:#991b1b;">
                                REJECTED
                            </span>
                        </div>

                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top:18px; border:1px solid #ffe4e6; border-radius:10px;">
                            <tr>
                                <td class="px" style="padding:14px 16px; background:#f8fafc; border-bottom:1px solid #ffe4e6;">
                        ...
                        <table role="presentation" cellpadding="0" cellspacing="0" width="100%" style="margin-top:20px;">
                            <tr>
                                <td align="left">
                                    <a href="{{ $loanShowUrl }}" class="cta" style="display:inline-block; background:#dc2626; color:#ffffff; text-decoration:none; font-weight:700; font-size:14px; padding:12px 16px; border-radius:10px;">
                                        View Application
                                    </a>
                                </td>
                            </tr>
                        ...
                        <div style="margin-top:18px; font-size:12px; color:#64748b; line-height:1.6;">
                            If you’d like to understand next steps or reapply, please contact support.
                        </div>
                    </td>
                </tr>
