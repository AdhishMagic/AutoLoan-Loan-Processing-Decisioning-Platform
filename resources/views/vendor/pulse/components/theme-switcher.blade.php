...
setDarkClass = () => {
    try {
        ...
        // localStorage blocked by browser - fallback to system preference
...
<div
    ...
    x-data="{
        menu: false,
        theme: (() => { try { return localStorage.theme } catch(e) { return undefined } })(),
        darkMode() {
            this.theme = 'dark'
...
>
    ...
    <div x-show="menu" class="z-10 absolute origin-top-right right-0 bg-white dark:bg-gray-800 rounded-md ring-1 ring-gray-900/5 shadow-xl flex flex-col overflow-hidden" style="display: none;" @click="menu = false">
        ...
        <button class="flex items-items px-4 py-2 gap-3 hover:bg-gray-100 dark:hover:bg-gray-700" :class="theme === undefined ? 'text-gray-900 dark:text-gray-100' : 'text-gray-500 dark:text-gray-400'" @click="systemMode()">
