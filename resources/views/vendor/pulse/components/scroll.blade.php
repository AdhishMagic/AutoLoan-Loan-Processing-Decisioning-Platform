...
<div
    ...
    {{ $attributes->merge(['class' => '@container/scroll-wrapper flex-grow flex w-full' . ($expand ? '' : ' basis-56 min-h-[200px]'), ':class' => "loading && 'opacity-25 animate-pulse'", 'style' => 'overflow: visible;']) }}
>
    <div
        x-ref="content"
        class="flex-grow basis-full overflow-y-auto overflow-x-visible space-y-1 scrollbar:w-1.5 scrollbar:h-1.5 scrollbar:bg-transparent scrollbar-track:bg-gray-100 scrollbar-thumb:rounded scrollbar-thumb:bg-gray-300 scrollbar-track:rounded dark:scrollbar-track:bg-gray-500/10 dark:scrollbar-thumb:bg-gray-500/50 supports-scrollbars"
