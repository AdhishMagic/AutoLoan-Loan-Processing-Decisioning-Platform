                ...
                @foreach ($queues as $queue => $readings)
                    <div wire:key="{{ $queue }}">
                        ...
                        <div class="mt-3 relative pt-8 pb-2">
                            ...
                            >
                                <canvas x-ref="canvas" class="w-full ring-1 ring-gray-900/5 dark:ring-gray-100/10 bg-gray-50 dark:bg-gray-800 rounded-md shadow-sm" style="height: auto !important; min-height: 120px;"></canvas>
                            </div>
                        </div>
                    </div>
                @endforeach
