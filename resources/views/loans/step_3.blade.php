    ...
    <div class="space-y-6">
        ...
        <form method="POST" action="{{ route('loans.step.store', ['loan' => $loan->id, 'step' => 3]) }}" class="space-y-8">
            ...
            <div class="bg-white p-4 rounded-lg border border-gray-200 shadow-sm">
                 ...
                 <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                    <div class="sm:col-span-3">
                        ...
                        <select name="employment_type" class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
            ...
            <div class="bg-gray-50 p-4 rounded-lg border border-gray-200">
                ...
                <div class="grid grid-cols-1 gap-x-6 gap-y-6 sm:grid-cols-6">
                     <div class="sm:col-span-3">
                        <label class="block text-sm font-medium text-gray-900">Gross Monthly Income (₹)</label>
                        <input type="number" name="gross_income" class="mt-2 block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                    <div class="sm:col-span-3">
